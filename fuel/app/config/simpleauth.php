...
return array(
	 ...
	 */
	'groups' => array(
                -1 => array('name' => 'Excluido', 'roles' => array('excluir')),
                1 => array('name' => 'Auditor', 'roles' => array('usuario', 'auditor')),
                20 => array('name' => 'Enfermera', 'roles' => array('usuario', 'auditor', 'enfermera')),
                50 => array('name' => 'Doctora', 'roles' => array('usuario', 'auditor', 'enfermera', 'doctora')),
                100 => array('name' => 'Admin', 'roles' => array('usuario', 'auditor', 'enfermera', 'doctora', 'admin')),
		/**
		 * Examples
		 * ---
		 *
